    ...
    Process {
        ...
        stdout: SplitParser {
            onRead: function(raw) {
                ...
                try {
                    var s = JSON.parse(d)
                    if (typeof s.panelThick    !== "undefined") win.panelThick    = s.panelThick
                ...
                Row {
                    ...
                    Repeater {
                        ...
                        delegate: Rectangle {
                            ...
                            Behavior on color{ColorAnimation{duration:150}}
                            Text{id:tbT;anchors.centerIn:parent;text:modelData;font.pixelSize:10;color:act?win.cAc:Qt.rgba(1,1,1,0.40)}
                ...
                Column {
                        ...
                        Grid { columns:3; spacing:6; width:parent.width
                            Repeater {
                                ...
                                delegate: Rectangle {
                                    ...
                                    border.color:act?win.cAc:"transparent"; border.width:1
                                    Behavior on color{ColorAnimation{duration:150}}
                                    Text{anchors.centerIn:parent;text:modelData.l;font.pixelSize:11;color:act?win.cAc:Qt.rgba(1,1,1,0.45)}
                        ...
                        Flow{width:parent.width;spacing:5
                            Repeater{model:["grow","fade","wave","wipe","slide","outer","any","random","none"]
                                delegate:Rectangle{
                                    ...
                                    border.color:act?win.cAc:"transparent";border.width:1
                                    Behavior on color{ColorAnimation{duration:150}}
                                    Text{id:tT;anchors.centerIn:parent;text:modelData;font.pixelSize:10;color:act?win.cAc:Qt.rgba(1,1,1,0.42)}
                        ...
                        Row{spacing:6
                            Repeater{model:[{k:"slide",l:"Deslizar"},{k:"fade",l:"Fade"},{k:"scale",l:"Escala"},{k:"bounce",l:"Bounce"}]
                                delegate:Rectangle{
                                    ...
                                    width:aT.implicitWidth+16;height:28;radius:14
                                    color:act?Qt.rgba(win.cAc.r,win.cAc.g,win.cAc.b,0.22):Qt.rgba(1,1,1,0.06)
                                    border.color:act?win.cAc:"transparent";border.width:1
                                    Behavior on color{ColorAnimation{duration:150}}
                                    Text{id:aT;anchors.centerIn:parent;text:modelData.l;font.pixelSize:10;color:act?win.cAc:Qt.rgba(1,1,1,0.45)}
                                    MouseArea{anchors.fill:parent;onClicked:win.openStyle=modelData.k}
                                }
                            }
                        }
                        Text{text:"Anima\u00e7\u00e3o ao trocar de lado";font.pixelSize:10;color:Qt.rgba(1,1,1,0.45)}
                        Row{spacing:6
                            Repeater{model:[{k:"shooter",l:"Rastro"},{k:"fade",l:"Fade"},{k:"none",l:"Instant\u00e2neo"}]
                                delegate:Rectangle{
                                    property bool act:win.moveStyle===modelData.k
                                    width:mT.implicitWidth+16;height:28;radius:14
                                    color:act?Qt.rgba(win.cAc.r,win.cAc.g,win.cAc.b,0.22):Qt.rgba(1,1,1,0.06)
                                    border.color:act?win.cAc:"transparent";border.width:1
                                    Behavior on color{ColorAnimation{duration:150}}
                                    Text{id:mT;anchors.centerIn:parent;text:modelData.l;font.pixelSize:10;color:act?win.cAc:Qt.rgba(1,1,1,0.45)}
                    ...
                    Column { visible:win.cfgTab===2; width:parent.width; spacing:14
                        ...
                        Row{spacing:10;width:parent.width
                            Item {
                                id: slOp; width: parent.width-50; height: 22
                                property real slFrom: 0.10; property real slTo: 0.98
                                property real slVal:  win.pillOpacity
                                Rectangle {
                                    anchors.verticalCenter: parent.verticalCenter
                                    width: parent.width; height: 5; radius: 2.5; color: Qt.rgba(1,1,1,0.13)
                                    Rectangle {
                                ...
                                Rectangle {
                                    x: Math.max(0,Math.min(1,(slOp.slVal-slOp.slFrom)/(slOp.slTo-slOp.slFrom)))*(slOp.width-18)
                                    anchors.verticalCenter: parent.verticalCenter
                                ...
                                MouseArea {
                                    ...
                                    function calc(mx) {
                                        return slOp.slFrom + Math.max(0,Math.min(1,(mx-9)/(slOp.width-18)))*(slOp.slTo-slOp.slFrom)
                                    }
                                    onPressed:         { slOp.slVal = calc(mouseX); win.pillOpacity=slOp.slVal }
                                    onPositionChanged: { if(pressed){ slOp.slVal = calc(mouseX); win.pillOpacity=slOp.slVal } }
                                    onReleased:        { slOp.slVal = calc(mouseX); win.pillOpacity=slOp.slVal }
                                }
                            }
                        ...
                        Row{spacing:10;width:parent.width
                            Item {
                                id: slTh; width: parent.width-50; height: 22
                                property real slFrom: 140; property real slTo: 360
                                ...
                                Rectangle {
                                    x: Math.max(0,Math.min(1,(slTh.slVal-slTh.slFrom)/(slTh.slTo-slTh.slFrom)))*(slTh.width-18)
                                    anchors.verticalCenter: parent.verticalCenter
                                    width: 18; height: 18; radius: 9; color: win.cAc; antialiasing: true
                                    Rectangle { anchors.centerIn: parent; width: 8; height: 8; radius: 4; color: "white"; opacity: 0.9 }
                                }
                                MouseArea {
                                    anchors.fill: parent; anchors.margins: -8
                                    function calc(mx) {
                                        return slTh.slFrom + Math.max(0,Math.min(1,(mx-9)/(slTh.width-18)))*(slTh.slTo-slTh.slFrom)
                                    }
                                    onPressed:         { slTh.slVal = calc(mouseX); }
                                    onPositionChanged: { if(pressed){ slTh.slVal = calc(mouseX); } }
                                    onReleased:        { slTh.slVal = calc(mouseX); win.panelThick=Math.round(slTh.slVal) }
                                }
                            }
                    ...
                    Column { visible:win.cfgTab===3; width:parent.width; spacing:12
                        ...
                        Text{font.pixelSize:9;color:Qt.rgba(1,1,1,0.30);text:"~/Pictures/Wallpapers/WallpaperSelector/"}
                    ...
                    Column { visible:win.cfgTab===4; width:parent.width; spacing:14
                        ...
                        Row{spacing:10;width:parent.width
                            Item {
                                id: slSp; width: parent.width-50; height: 22
                                ...
                                Rectangle {
                                    x: Math.max(0,Math.min(1,(slSp.slVal-slSp.slFrom)/(slSp.slTo-slSp.slFrom)))*(slSp.width-18)
                                    anchors.verticalCenter: parent.verticalCenter
                                    width: 18; height: 18; radius: 9; color: win.cAc; antialiasing: true
                                    Rectangle { anchors.centerIn: parent; width: 8; height: 8; radius: 4; color: "white"; opacity: 0.9 }
                                }
                                MouseArea {
                                    anchors.fill: parent; anchors.margins: -8
                                    function calc(mx) {
                                        return slSp.slFrom + Math.max(0,Math.min(1,(mx-9)/(slSp.width-18)))*(slSp.slTo-slSp.slFrom)
                                    }
                                    onPressed:         { slSp.slVal = calc(mouseX); }
                                    onPositionChanged: { if(pressed){ slSp.slVal = calc(mouseX); } }
                                    onReleased:        { slSp.slVal = calc(mouseX); win.panelSpan=slSp.slVal }
                                }
                            }
                        ...
                        Row{spacing:10;width:parent.width
                            Item {
                                id: slRa; width: parent.width-50; height: 22
                                ...
                                Rectangle {
                                    x: Math.max(0,Math.min(1,(slRa.slVal-slRa.slFrom)/(slRa.slTo-slRa.slFrom)))*(slRa.width-18)
                                    anchors.verticalCenter: parent.verticalCenter
                                    width: 18; height: 18; radius: 9; color: win.cAc; antialiasing: true
                                    Rectangle { anchors.centerIn: parent; width: 8; height: 8; radius: 4; color: "white"; opacity: 0.9 }
                                }
                                MouseArea {
                                    anchors.fill: parent; anchors.margins: -8
                                    function calc(mx) {
                                        return slRa.slFrom + Math.max(0,Math.min(1,(mx-9)/(slRa.width-18)))*(slRa.slTo-slRa.slFrom)
                                    }
                                    onPressed:         { slRa.slVal = calc(mouseX); win.thumbRadius=Math.round(slRa.slVal) }
                                    onPositionChanged: { if(pressed){ slRa.slVal = calc(mouseX); win.thumbRadius=Math.round(slRa.slVal) } }
                                    onReleased:        { slRa.slVal = calc(mouseX); win.thumbRadius=Math.round(slRa.slVal) }
                                }
                            }
